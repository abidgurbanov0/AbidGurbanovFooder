...
extension RestoranPageVC : UICollectionViewDataSource , UICollectionViewDelegate{
    ...
    func cellDesign(){
        ...
        let designe = UICollectionViewFlowLayout()
         ...
         designe.minimumLineSpacing = 10 // dikey
         
        
        let width = restoranCollectionView.bounds.width-20
         designe.itemSize = CGSize(width: width, height: 120 )
        restoranCollectionView.collectionViewLayout = designe
    ...
    func cell2Design(){
        ...
        designe.sectionInset = UIEdgeInsets(top: 5, left: 5, bottom: 5, right: 5)
    
        designe.scrollDirection = .horizontal
        
        let width = sliderCollectionView.bounds.width - 10
        
         designe.itemSize = CGSize(width: width, height: sliderCollectionView.bounds.height-10 )
        sliderCollectionView.collectionViewLayout = designe
    }
